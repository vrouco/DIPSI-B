...
names(DIPSI_facets)[28:31]<- c("SENS_rm", "FANT_rm","DAYD_rm", "ODDT_rm") #include "r" in the "rm" so names converge

DIPSI_small <- DIPSI_facets  #begin the list for the brief facets
